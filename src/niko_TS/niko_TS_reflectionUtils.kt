...
object niko_TS_reflectionUtils { // yoinked from exotica which yoinked it from rat i love starsector dev
    ...
    fun get(fieldName: String, instanceToGetFrom: Any, classToGetFrom: Class<out Any> = instanceToGetFrom::class.java): Any? {
        ...
        try {
            ...
            try {
                ...
                //niko_TS_debugUtils.log.error(e)
            }
        }
    ...
    fun createClassThroughCustomLoader(claz: Class<*>): MethodHandle {
        ...
        val reflectionLoader: Class<*> = object : URLClassLoader(urls, getSystemClassLoader()) {
        }.loadClass(claz.name)
